...
using nOAuth.AuthorizationServer.Infrastructure;
using nOAuth.AuthorizationServer.Models;

namespace nOAuth.AuthorizationServer.Controllers
{
    public class OAuthController : Controller
    {
        private readonly DotNetOpenAuth.OAuth2.AuthorizationServer authorizationServer = new DotNetOpenAuth.OAuth2.AuthorizationServer(new OAuth2AuthorizationServer());
        ...
        public ActionResult AuthorizeResponse(bool isApproved)
        {
            ...
            if (isApproved)
            {
                ...
                var username = "zhangsan";//HttpContext.User.Identity.Name;
