...
namespace nOAuth.AuthorizationServer.Infrastructure
{
    internal class OAuth2AuthorizationServer : IAuthorizationServerHost
    {
        ...
        public AccessTokenResult CreateAccessToken(IAccessTokenRequest accessTokenRequestMessage)
        {
            ...
            var times = System.Configuration.ConfigurationManager.AppSettings["OAuth.Lifetime"].ToInt(60);
            accessToken.Lifetime = TimeSpan.FromMinutes(times);
